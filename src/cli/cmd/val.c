...
int proctal_cmd_val_add(enum proctal_cmd_val_type type, void *v1, void *v2, void *r);
int proctal_cmd_val_sub(enum proctal_cmd_val_type type, void *v1, void *v2, void *r);
