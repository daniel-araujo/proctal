...
#define PROCTAL_X86_64_DR_0 0
#define PROCTAL_X86_64_DR_1 1
#define PROCTAL_X86_64_DR_2 2
#define PROCTAL_X86_64_DR_3 3
#define PROCTAL_X86_64_DR_4 4
#define PROCTAL_X86_64_DR_5 5
#define PROCTAL_X86_64_DR_6 6
#define PROCTAL_X86_64_DR_7 7

#define PROCTAL_X86_64_DR_RW_X 0
#define PROCTAL_X86_64_DR_RW_W 1
#define PROCTAL_X86_64_DR_RW_RW 3

#define PROCTAL_X86_64_DR_LEN_1B 0
#define PROCTAL_X86_64_DR_LEN_2B 1
#define PROCTAL_X86_64_DR_LEN_4B 3
 ...
 * enabled.
 */
void proctal_x86_64_dr_l_set(unsigned long long *dr7, int r, int enable);
/*
 * Checks whether a local breakpoint is enabled.
 *
 * If the return value is 0 it's disabled, if 1 it's enabled.
 */
int proctal_x86_64_dr_l(unsigned long long dr7, int r);
