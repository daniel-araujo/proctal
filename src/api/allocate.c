...
void proctal_allocate_read_set(struct proctal *p, int r)
{
	p->allocate.read = r != 0;
}
...
void proctal_allocate_write_set(struct proctal *p, int w)
{
	p->allocate.write = w != 0;
}
...
void proctal_allocate_execute_set(struct proctal *p, int x)
{
	p->allocate.execute = x != 0;
}
